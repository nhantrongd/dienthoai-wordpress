...
function ceylon_demo_setup_get_templates_lists( $theme_slug ){
    ...
    switch ($theme_slug):	
		...
		case ($theme_slug == "ecommerce-plus" || $theme_slug == "web-design" || $theme_slug == "shop-online" || $theme_slug == "fast-storefront" || $theme_slug == "techno" || $theme_slug == "green-shop" || $theme_slug == "mega-storefront" || $theme_slug == "shop-starter"  || $theme_slug == "digital-shop" || $theme_slug == "my-storefront") :
			$theme_slug = "general";
            $demo_templates_lists = array(
