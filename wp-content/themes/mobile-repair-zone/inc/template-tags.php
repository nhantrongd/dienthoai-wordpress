...
if (!function_exists('mobile_repair_zone_comment')) :
     ...
     */
    function mobile_repair_zone_comment($comment, $mobile_repair_zone_args, $depth){
        ...
        <li id="comment-<?php comment_ID(); ?>" <?php comment_class(empty($mobile_repair_zone_args['has_children']) ? '' : 'parent'); ?>>
            <article id="div-comment-<?php comment_ID(); ?>" class="comment-body media mb-4">
                <a class="pull-left" href="#">
                    <?php if (0 != $mobile_repair_zone_args['avatar_size']) echo get_avatar($comment, $mobile_repair_zone_args['avatar_size']); ?>
                </a>
                        ...
                        <?php comment_reply_link(
                            array_merge(
                                $mobile_repair_zone_args, array(
                                    ...
                                    'depth' => $depth,
                                    'max_depth' => $mobile_repair_zone_args['max_depth'],
